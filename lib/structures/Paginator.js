                    ...
                    if (event === "MESSAGE_REACTION_ADD" &&
                        ...
                        switch (data.emoji.name) {
                            ...
                            case listener.reactions.skipTo:
                                listener.waitingForPage = true;
                                this.client.rest.createMessage(data.channel_id, "What page do you want to go to?");
                                break;
                        }
                        ...
                        listener.jumpTo(page - 1)
                            .then(() => listener.waitingForPage = false);
                    }
                    console.log(event, listener.commandMessage.channelId, data.channel_id, listener.waitingForPage);
                }
            }
        });
    }
